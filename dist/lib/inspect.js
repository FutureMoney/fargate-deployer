...
exports.inspectFacts = inspectFacts;
exports.formatFacts = formatFacts;
...
function inspectFacts(config) {
    ...
    if (config.kind === 'Service' && config.loadBalancer) {
        ...
        const loadBalancerArn = lb.loadBalancerArn ??
            (lb.listenerArn ? (0, alb_1.loadBalancerArnFromListener)(lb.listenerArn) : undefined);
        if (loadBalancerArn) {
