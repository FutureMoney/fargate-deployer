...
function fromSecretsManager(scope: Construct, name: string, arn: string): ecs.Secret {
...
function fromParameterStore(scope: Construct, name: string, arn: string): ecs.Secret {
 ...
 */
export function splitSecretsManagerArn(arn: string): { secretArn: string; jsonField?: string } {
